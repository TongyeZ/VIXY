...
crash, the price of VIXY options gets pushed higher. This creates a hidden fee inside the price of the options. By looking at three years of historical data, our project uses the Put-Call Parity to figure out exactly how much the borrow cost is. Our
